...
const BodyServices = () => {
    ...
    return (
        <section className="features my-5" id="bodyServices">
            <div className="container">
                <div className="row">
                        ...
                        <div className="col-1"><HashLink to="/#navbar"><FontAwesomeIcon className="cart-iconLink text-info fs-1" icon={faArrowAltCircleUp} /></HashLink>
                        </div>
